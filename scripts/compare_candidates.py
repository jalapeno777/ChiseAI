...
"""
    ...
    if sum(improvements) >= 3:
        ...
        report += f"**VERDICT: NO CLEAR WINNER** →\n\n"
        report += f"Both versions show similar candidate quality.\n\n"
...
"""
    ...
    if sum(improvements) >= 3:
        report += f"**PROCEED TO PROMOTION PACKET** ✅\n\n"
        ...
        report += f"**CONDITIONAL PROCEED** ⚠️\n\n"
        report += (
