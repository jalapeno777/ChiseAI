...
| **weekly-security-audit**    | Cron-only full dependency audit plus full Bandit sweep on `main`                                                  | security-team | [incident_response](incident_response.md)                                                              | [incident_response](incident_response.md)       |
