...
<activation critical="MANDATORY">
      ...
      <step n="7">STOP and WAIT for user input - do NOT execute menu items automatically - accept number or cmd trigger or fuzzy command match (unless `BMAD_TASK_MODE=1` or `NO_INTERACTIVE_MENUS=1`)</step>
