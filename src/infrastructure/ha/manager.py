...
from src.infrastructure.ha.failover import FailoverConfig, FailoverManager, FailoverState, InstanceInfo
from src.infrastructure.ha.health_check import HealthCheckConfig, HealthCheckRegistry, HealthCheckResult, HealthStatus
from src.infrastructure.ha.load_balancer import LoadBalancer, LoadBalancerConfig, LoadBalancingStrategy
from src.infrastructure.ha.uptime_monitor import Alert, UptimeMonitor, UptimeMonitorConfig, UptimeTarget
...
class HighAvailabilityManager:
    ...
    def get_instance(self, service_name: str, session_id: str | None = None) -> Optional[InstanceInfo]:
...
_global_manager: Optional[HighAvailabilityManager] = None
