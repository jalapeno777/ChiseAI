...
def build_session_context(
    ...
    all payloads against the staleness invariants.
    ...
    # Note: legacy_missing is populated by _extract_tier_context
    # during payload validation - no additional computation needed
